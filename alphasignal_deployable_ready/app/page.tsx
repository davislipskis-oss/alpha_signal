    ...
    <main>
      ...
      <section className="section">
        <div className="container grid-2">
          <ClientAuth />
          <div className="card">
            <div className="kicker">Why people pay</div>
            <h3>This is not entertainment pricing.</h3>
            <p>
              The buyer is not comparing you to Netflix. They are comparing you to one expensive mistake. Price the product like a decision shield.
            </p>
            <div className="list">
              <div className="list-item"><span className="dot" /><span>Free gets them curious.</span></div>
              <div className="list-item"><span className="dot" /><span>Pro makes the habit sticky.</span></div>
              <div className="list-item"><span className="dot" /><span>Trader monetizes the people who already think in margins.</span></div>
              <div className="list-item"><span className="dot" /><span>Lifetime creates immediate cash flow while the product is early.</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="lead">Keep the product framed around analytics, probabilities, and scenario views. That makes the signal feel sharper and the legal posture cleaner.</p>
          <FAQ />
        </div>
      </section>
      ...
      <section className="section">
        <div className="container card" style={{ textAlign: 'center' }}>
          ...
          <p className="lead" style={{ marginInline: 'auto' }}>Deploy this now, validate demand, and then wire in Supabase, Stripe, and live Cardmarket ingestion on top of a structure that already knows what it is.</p>
