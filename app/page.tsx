    ...
    <main>
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <p>
              AlphaSignal helps sealed collectors make cleaner decisions around entries, hold discipline, and watchlist timing without turning the product into noise.
            </p>
            ...
            <div className="proof-strip">
              <div className="proof-item"><strong>6 launch models</strong><span>chosen for collector relevance, not filler</span></div>
              <div className="proof-item"><strong>EU-first logic</strong><span>signals framed around the market you actually buy in</span></div>
              <div className="proof-item"><strong>Alert workflow</strong><span>thresholds, activity history, and optional browser notifications</span></div>
            </div>
          </div>
          <div className="oracle-card card">
            ...
            <div className="oracle-overlay">
              ...
              <p>
                Elegant by design, ruthless in purpose. It turns noise into a signal you can actually use.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container grid-3">
          ...
          <div className="card">
            ...
            <h3>A workflow people can actually stick to.</h3>
            <p>
        ...
        <div className="container grid-2">
          ...
          <div className="card">
            ...
            <div className="list">
              ...
              <div className="list-item"><span className="dot" /><span>Know exactly how alerts are delivered and when they fired.</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="pricing">
        <div className="container">
          <h2>Pricing built for real usage, not vague promises.</h2>
          <p className="lead">
            Start free, upgrade when the workflow becomes part of how you buy, hold, and monitor sealed product.
          </p>
          <PricingGrid />
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="lead">
            AlphaSignal gives you analytical signals, alerting logic, and market context without pretending certainty where none exists.
          </p>
          <FAQ />
        </div>
      </section>
      ...
      <section className="section">
        <div className="container card hero-close" style={{ textAlign: 'center' }}>
          ...
          <p className="lead" style={{ marginInline: 'auto' }}>
            Use the analyzer, log your inventory, and set thresholds that tell you when a product actually deserves your attention.
          </p>
          <div className="cta-row" style={{ justifyContent: 'center' }}>
            <Link href="/analyzer" className="btn btn-primary">Run the analyzer</Link>
            <Link href="/contact" className="btn btn-secondary">Contact AlphaSignal</Link>
          </div>
        </div>
      </section>
    </main>
